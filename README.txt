...
The UI alows you to set puzzle cells by setting the x position, y position and the puzzle cell value.
...
There is no visual representation of the puzzle 
When the puzzle is set click 'Get' which will return the solution in the grid
Clicking 'Get' without setting any puzzle cells will return the most natural solution to the solver
